...
*Comparación exacta entre la frase original y lo escrito.

*Interfaz gráfica simple y funcional creada con tkinter.

*Mensajes de retroalimentación sobre precisión y tiempo total.
...
*random (selección de frases)

*time (medición de velocidad)
